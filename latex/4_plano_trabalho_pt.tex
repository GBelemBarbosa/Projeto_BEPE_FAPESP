...
\begin{enumerate}
    ...
    \item \textbf{Mês 6-8: Implementação Computacional (Fase 3)} \\
    Implementação paralela dos algoritmos projetados na linguagem Julia, integrando os modelos desenvolvidos no Brasil ao framework JSO.
