...
\begin{enumerate}
    ...
    \item \textbf{Month 6-8: Computational Implementation (Phase 3)} \\
    Parallel implementation of the designed algorithms in the Julia language, integrating the models developed in Brazil into the JSO framework.
